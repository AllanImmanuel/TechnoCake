<ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
  ...
  <li class="nav-item">
    <a class="nav-link" href="<?php echo e(route('producto')); ?>">
      <i class="fas fa-fw fa-tachometer-alt"></i>
      <span>Producto</span></a>
  </li>
  <li class="nav-item">
    <a class="nav-link" href="<?php echo e(route('Pedidos')); ?>">
      <i class="fas fa-fw fa-tachometer-alt"></i>
      <span>Pedidos</span></a>
  </li>
  <li class="nav-item">
...
</ul><?php /**PATH C:\laragon\www\techno\TechnoCake-Reloaded\resources\views/layouts/sidebar.blade.php ENDPATH**/ ?>